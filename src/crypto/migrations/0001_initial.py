# Generated by Django 3.2 on 2021-04-22 18:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Quote',
            fields=[
                ('timestamp', models.CharField(max_length=512, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_types', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=64, null=True), size=10)),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='symbol',
            constraint=models.UniqueConstraint(fields=('name', 'base_asset', 'quote_asset'), name='unique_per_symbol_pairs'),
        ),
        migrations.AddField(
            model_name='quote',
            name='symbol',
            field=models.ForeignKey(max_length=128, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quotes', to='crypto.symbol'),
        ),
    ]
